...
function useProvideAuth(): UseAuthContext {
    const [user, setUser] = useState<User>(JSON.parse(sessionStorage.getItem('user') || JSON.stringify(defaultUser)));

    const [authenticated, setAuthenticated] = useState<boolean>(JSON.parse(sessionStorage.getItem('authenticated') || 'false'));
